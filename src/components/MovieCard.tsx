...
const MovieCard = ({ movie }: { movie: Movie }) => {
  ...
  return (
    ...
    >
      <div className="w-70 h-40 absolute rounded-sm group-hover:w-90 group-hover:h-50 group-hover:z-100 group-hover:top-[-50px] group-hover:shadow-[0_2px_10px_black]">
        <img
        ...
        <div className="movie-card-info shadow-[0_2px_10px_black]">
